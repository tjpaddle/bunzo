...
for unit in bunzo-shell.service bunzod.socket bunzod.service bunzo-schedulerd.service bunzo-provisiond.socket bunzo-provisiond.service bunzo-provisioning-reconcile.service bunzo-setup-http.socket bunzo-setup-http.service; do
...
for bin in bunzo-shell bunzod bunzo-schedulerd bunzo-provisiond bunzo-setup-httpd; do
